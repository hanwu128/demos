  ...
  <div class="body_content">
    <div class="menu_list">
      <ul class="operate_nav">
        ...
        <!--2018.3.7新增链接-->
        <li class="li3">
          <router-link to="/edge/manager"><label class="operate_nav_a" :class="{'active':module_name=='manager'}" @click="menu_li_click(5)"><i></i><span>设备管理</span></label></router-link>
        </li>
        <li class="li5">
          <router-link to="/edge/deljs"><label class="operate_nav_a" :class="{'active':module_name=='deljs'}" @click="menu_li_click(4)"><i></i><span>流计算</span></label></router-link>
        </li>
        <li class="li4">
          <router-link to="/edge/deImage"><label class="operate_nav_a" :class="{'active':module_name=='deImage'}" @click="menu_li_click(3)"><i></i><span>数字镜像</span></label></router-link>
        </li>
        <!-- <li class="li5">
        ...
        <li class="li5">
          <router-link to="/edge/desjdc"><label class="operate_nav_a" :class="{'active':module_name=='desjdc'}" @click="menu_li_click(4)"><i></i><span>数据洞察</span></label></router-link>
        </li>
