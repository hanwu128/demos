...
//        }
      ...
      //  System.out.println("stringArrayAlianame:::-->>>>"+stringArrayAlianame);
       ...
       List<JSONObject> value11 = IAMConsumer.getValueByKeyFromETCD(null,path,"foo",null);
        ...
        List<JSONObject> value22 = IAMConsumer.getValueByKeyFromETCD(null,path,"foo2",null);
