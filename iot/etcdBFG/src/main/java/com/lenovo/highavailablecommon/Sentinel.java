...
//        }
    ...
    public Sentinel(Object _ThreadLockFlag,
                    Map<String,String> mapForRabbitMQ,
                    JSONArray _JSONArrayMasterKV,
                    JSONArray _JSONArrayMasterETCDClusterNode){
        super();
        this._ThreadLockFlag = _ThreadLockFlag;
        this.mapForRabbitMQ = mapForRabbitMQ;
    ...
    public static String callOneThreadToLiveETCDSentinel(JSONObject _JSONObjectParameter,
        ...
        (new Thread(new Sentinel(_ThreadLockFlag,mapForRabbitMQ,_JSONArrayMasterKV,_JSONArrayMasterETCDClusterNode))).start();
