...
public class SSL {
	...
	public SSLSocketFactory getSSLSocktet() throws Exception {		
		...
		FileInputStream caIn = new FileInputStream(path + CA_PATH);
	...
	public SSLSocketFactory getSSLSocktetBidirectional() throws Exception {
		...
		FileInputStream crtIn = new FileInputStream(path + CRT_PATH);
		...
		ks.setKeyEntry("private-key", getPrivateKey(path + KEY_PATH), PASSWORD.toCharArray(), new java.security.cert.Certificate[] { caCert });
