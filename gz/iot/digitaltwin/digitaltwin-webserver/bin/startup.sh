...
nohup $JAVA $OPTS_JAVA -classpath $CLASSPATH com.lenovo.iot.digitaltwin.DtJettyWebServer -d $webroot >/dev/null 2>&1 & echo $! > $pid_file
#$JAVA $OPTS_JAVA -classpath $CLASSPATH com.lenovo.iot.digitaltwin.DtJettyWebServer -d $webroot & echo $! > $pid_file
