<template>
    <div>
        <div class="page_title_content">
            <span class="page_title">冷链应用&nbsp;&gt;&nbsp;<router-link to="/application/realtimeData" class="btn_color">实时数据</router-link>&nbsp;&gt;&nbsp;详情</span>
        </div>
        ...
        <div class='btn_div'>
            <router-link to="/application/realtimeData" class='btn_back'>返回</router-link>
        </div>
    </div>
</template>
<script>
