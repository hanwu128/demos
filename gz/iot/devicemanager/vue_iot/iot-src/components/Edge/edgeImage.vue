<template>
  <div>
    <div class="page_title_content">
      <span class="page_title">边缘分析&nbsp;&gt;&nbsp;<router-link to="/edge/deImage" class="btn_color">数字镜像管理</router-link></span>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      deleteInfo:function (index) {
        ...
        this.$confirm('确定要删除设备“'+ this.deviceInfo[index].digitaltwinname +'”吗？删除后设备将无法接入系统。', '提示', {
