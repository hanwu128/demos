  ...
  <div>
    ...
    <div class="right_content">
      ...
      <ul class="label_ul">
        ...
        <li v-if='!importShow'>
          <label style='vertical-align: top;'class="label_title">网关设备描述：</label><span  class="li_content">
            <el-input
              type="textarea"
              :autosize="{ minRows: 2, maxRows: 2}"
              :maxlength='descLength'
              resize="none"
              placeholder="请输入网关设备描述"
              v-model="desc"
              clearable>
            </el-input>
          </span>
        ...
        <li v-if='importShow'>
          ...
          <p class='tip_text normal' style="margin-top:10px;margin-bottom:20px;">（批量上传一次最多上传200个网关设备，设备名称为必填项，<br>设备名称内容不得重复，请仔细比对上传模板内的内容。）</p>
        </li>
      </ul>
        ...
        <table class="list">
          <thead>
            <tr>
              ...
              <th style='width:30%'>网关设备名称</th>
              <th style='width:30%'>网关设备描述</th>
      ...
      save: function () {
        ...
        this.$axios.post(this.$API.edgeManage.deviceAdd,{
          ...
          if(obj.result == true){
            ...
            this.$message.error('保存失败！网关设备名称已存在。');
          }else {
