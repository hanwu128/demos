<template>
    <div>
        <div class="page_title_content">
          <span class="page_title">边缘分析&nbsp;&gt;&nbsp;<router-link to="/edge/manager" class="btn_color">设备管理</router-link>&nbsp;&gt;&nbsp;设备详情</span>
        </div>
        <div class="right_content">
            <!--网关设备信息-->
            <div class="gateWay">
                <span class="module_title">设备信息</span>
            ...
            <div class="list_detail">
                <table class="gateWayInfoTable">
                    <tr>
                        <td class='table_th' style='width:20%'>设备设备名称</td>
                        <td style='width:30%'>{{this.deviceDetail.access_key}}</td>
                        <td class='table_th' style='width:20%'>设备ID</td>
                        <td style='width:30%'>{{this.deviceDetail.device_id}}</td>
                    </tr>
                    <tr>
                        <td class='table_th'>设备型号</td>
            ...
            <!--网关设备描述-->
            <div class="gateWay">
                <span class="module_title">设备描述</span>
                <p class="gateWayDes">
        ...
        <div v-if= "gateWayisShow" class="dialogTask">
            <div class="catlog"><h3>设备秘钥</h3><span class="cancel_btn" @click="gateway_close">×</span></div>
