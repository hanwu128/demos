package com.hw.client.login;

import com.hw.client.chatroom.CatChatroom;
import com.hw.client.function.ClientBean;
import com.hw.client.until.CatUtil;
    ...
    public CatLogin() {
        ...
        contentPane = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                g.drawImage(new ImageIcon("D:\\workspace\\idea\\cat_chat_client\\src\\main\\resources\\static\\images\\登陆界面.jpg").getImage(), 0, 0, getWidth(), getHeight(), null);
            }
        };
        ...
        btnNewButton.setIcon(new ImageIcon("D:\\workspace\\idea\\cat_chat_client\\src\\main\\resources\\static\\images\\登陆.jpg"));
        btnNewButton.setBounds(246, 227, 50, 25);
        getRootPane().setDefaultButton(btnNewButton);
        contentPane.add(btnNewButton);

        final JButton btnNewButton_1 = new JButton();
        btnNewButton_1.setIcon(new ImageIcon("D:\\workspace\\idea\\cat_chat_client\\src\\main\\resources\\static\\images\\注册.jpg"));
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                File file = new File("D:\\workspace\\idea\\cat_chat_client\\src\\main\\resources\\Users.properties");
