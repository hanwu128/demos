package com.hw.client.chatroom;

import com.hw.client.function.CatBean;
...
public class CatChatroom extends JFrame {
    ...
    public CatChatroom(String u_name, Socket client) {
        ...
        try {
            ...
            // 消息提示声音
            file = new File("D:\\workspace\\idea\\cat_chat_client\\src\\main\\resources\\static\\sounds\\呃欧.wav");
            cb = file.toURL();
            aau = Applet.newAudioClip(cb);
            // 上线提示声音
            file2 = new File("D:\\workspace\\idea\\cat_chat_client\\src\\main\\resources\\static\\sounds\\叮.wav");
            cb2 = file2.toURL();
