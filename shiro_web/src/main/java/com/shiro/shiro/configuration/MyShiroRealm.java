package com.shiro.shiro.configuration;

import com.shiro.shiro.dao.IUserDao;
...
public class MyShiroRealm extends AuthorizingRealm {
     ...
     * 如果连续访问同一个URL（比如刷新），该方法不会被重复调用，Shiro有一*个时间间隔（也就是cache时间，在ehcache-shiro.xml中配置），超过这个时间间隔再刷新页面，该方法会被执行
     **/
    @Override
